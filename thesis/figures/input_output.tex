...
% Text Node
\draw (79.43,212.59) node [anchor=north west][inner sep=0.75pt]    {$\mathbf{X}^{t-s+1}$};
% Text Node
...
% Text Node
\draw (219.49,212.59) node [anchor=north west][inner sep=0.75pt]    {$\mathbf{X}^{t}$};
% Text Node
...
% Text Node
\draw (396.43,212.59) node [anchor=north west][inner sep=0.75pt]    {$\hat{\mathbf{Y}}^{t+1}$};
% Text Node
\draw (535.49,212.59) node [anchor=north west][inner sep=0.75pt]    {$\hat{\mathbf{Y}}^{t+h}$};
% Text Node
